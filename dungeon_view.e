...
feature
	...
	doBattle_Instruction(system:INTEGER;myDefense:INTEGER;enemyHP:INTEGER;enemyAttack:INTEGER;enemyDefense:INTEGER;virusesMade:INTEGER;virusAttack:INTEGER)
		...
		doBattle_worm
			do
				print("Your viruse power has been increased by 3 %N")
			end
		...
		app_Message_Bitcoin
			...
			do
				...
				print("Firewall would help build your defense%N")
				print("Worm increasing your virus power by 3 so you can beat enemy faster!%N")
			...
			app_beat_boss
				do
					print("You beat a boss and level up!%N")
				end
			...
			app_you_died
				do
				print("You died... The villager morns your death.%N")
